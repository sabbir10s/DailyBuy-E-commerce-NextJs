    ...
    return (
        <div
            ...
            <div className='relative w-full md:w-1/2 lg:w-1/3'>
                <div
                    className='bg-white w-full h-screen overflow-x-scroll flex flex-col justify-between '>
                    <div>
                        ...
                        <div>
                            ...
                            {cartItems.length > 0 && <div>
                                {cartItems.map(item =>< ShoppingItems item = {item} key = { item._id  } />)} </div>
                            }
                        </div>
                    </div>
                    ...
                    <div onClick={handleCloseCart} className='flex justify-center mb-4'>
                        <Link href='/checkout' className='block w-full mx-4'>
                            <button
                                className='bg-primary-600 hover:bg-primary-700 duration-300 font-semibold text-primary-600 w-full rounded-[8px] flex items-center justify-between  px-2 py-4'>
