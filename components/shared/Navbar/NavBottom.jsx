        ...
        <div className="container hidden lg:flex items-center justify-between gap-5 mt-2">
            <ul className="flex items-center">
                <div className="relative group">
                    ...
                    <div
                        className=" z-10 shadow-custom opacity-0 invisible group-hover:opacity-100 group-hover:visible bg-white hidden lg:block rounded-b-md absolute top-12 left-0 w-full transition duration-300 delay-100 ease-in-out">
