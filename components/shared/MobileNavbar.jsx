       ...
       <div className="flex h-20 max-w-screen-2xl items-center justify-between">
          <div className="flex items-center gap-2 md:gap-5 w-full md:w-2/3">
            <div>
              <Link href="/">
                {" "}
                <Image className="w-[110px] md:w-full h-full cursor-pointer" src={logo} alt="" />
              </Link>
            </div>
          ...
          <div className="flex flex-1 items-center justify-end">
            <div className=" flex items-center">
              <div className="flex items-center gap-2 md:gap-5">
                ...
                <div>
                  <Link href="/account" className="bg-gray-50 w-10 h-10 rounded-[50%] flex items-center justify-center">
