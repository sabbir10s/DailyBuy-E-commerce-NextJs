                ...
                <div className='container'>
                   <div className='flex items-center justify-center'>
                        <div className='hidden md:block'>
                            ...
                            <button className='bg-white text-primary-500 font-bold py-[20px] px-[65px] rounded-[10px] group'><span>@username</span>
                            <div className='bg-primary-500 w-2/3 group-hover:w-full duration-300 h-[2px]'></div>
                            </button>
                            </div>
                            <Image src={bottomBannerImg} alt="" />
                            </div>
                        </div>
                        <div className='block md:hidden'>
                            ...
                            <Image src={bottomMobileBanner} alt="" />
                            </div>
                        </div>
                   </div>
                </div>
