    ...
    <div className="container mt-2">
      <div className="flex items-center gap-20 w-full">
        <button
          ...
          className=" w-[250px] flex items-center justify-center gap-[11px] uppercase text-xl py-3 text-center bg-primary-600 text-white rounded-t-md cursor-pointer font-semibold">
