    ...
    return (
        ...
        <div className='flex flex-col lg:flex-row items-center gap-[48px] '>
                ...
                <div className='mt-[100px] mb-[120px] relative'>
                    ...
                    <div
                        className='bg-primary-500 rounded-br-[10px] w-[400px] h-[300px] absolute bottom-[-30px] right-[-30px] z-[-1] hidden lg:block'></div>
                </div>

                <div className='flex flex-col lg:flex-row gap-[36px] mt-[56px]'>
                    <div>
                        <h1 className='text-2xl lg:text-4xl text-[#383838] font-bold'>Our Commitment
                        </h1>
                        <p className='text-sm lg:text-lg text-[#626463] my-[32px]'>A wonderful serenity
                            has taken possession of my entire soul, like these sweet mornings
                            <br/>
                            <br/>
                            of spring which I enjoy with my whole heart. I am alone, and feel the charm of
                    ...
                    <div className='flex  flex-col-reverse lg:flex-col'>
                        ...
                        <div>
                            ...
                            <p className='text-sm lg:text-lg text-[#626463] mb-[32px] lg:mb-0'>A wonderful
