        ...
        <div className=' flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-24 mt-[65px]'>
            <div className=' text-center flex flex-col items-center justify-center'>
                <div className=' w-[80px] lg:w-[130px] h-[80px] lg:h-[130px] flex items-center justify-center rounded-full bg-primary-50'>
                    <Image className='w-[50px] lg:w-[75px]' src={fruitsAndVegetable} alt=""/>
                </div>
            ...
            <div className=' text-center flex flex-col items-center justify-center'>
                <div className=' w-[80px] lg:w-[130px] h-[80px] lg:h-[130px] flex items-center justify-center rounded-full bg-primary-50'>
                    <Image className='w-[50px] lg:w-[75px]' src={MeatsFish} alt=""/>
                </div>
            ...
            <div className=' text-center flex flex-col items-center justify-center'>
                <div className=' w-[80px] lg:w-[130px] h-[80px] lg:h-[130px] flex items-center justify-center rounded-full bg-primary-50'>
                    <Image className='w-[50px] lg:w-[75px]' src={BreadsBakery} alt=""/>
                </div>
            ...
            <div className=' text-center flex flex-col items-center justify-center'>
                <div className=' w-[80px] lg:w-[130px] h-[80px] lg:h-[130px] flex items-center justify-center rounded-full bg-primary-50'>
                    <Image className='w-[50px] lg:w-[75px]' src={BreakfastDairy} alt=""/>
                </div>
            ...
            <div className=' text-center flex flex-col items-center justify-center'>
                <div className=' w-[80px] lg:w-[130px] h-[80px] lg:h-[130px] flex items-center justify-center rounded-full bg-primary-50'>
                    <Image className='w-[50px] lg:w-[75px]' src={FrozenFoods} alt=""/>
                </div>
