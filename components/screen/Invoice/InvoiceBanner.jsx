...
const InvoiceBanner = () => {
    return (
        <div className="container mt-[80px] lg:mt-[40px]">
            <div
                className="relative bg-primary-600 rounded-[10px] text-white text-[14px] lg:text-[18px]">
                <Image
                ...
                <div className="">
                    <div
                        className="flex flex-col md:flex-row justify-between p-[14px] md:p-[30px] lg:p-[71px] gap-[26px]">
