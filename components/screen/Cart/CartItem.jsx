...
const CartItem = ({item}) => {
    ...
    return (
        <div>
            <div
                className="flex justify-between lg:grid  grid-cols-7 lg:gap-2 items-center lg:m-[7px] bg-white">
                <div className='flex items-center lg:col-span-3'>
                    <div className='p-2'>
                        <div
                            className="w-[80px] lg:w-[100px] h-[80px] lg:h-[100px] bg-gray-50  rounded-2xl">
                            <Image
                                width={100}
                                height={100}
                                src={main_img_url}
