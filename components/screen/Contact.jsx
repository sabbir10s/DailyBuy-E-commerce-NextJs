...
const Contact = () => {
    return (
        <div>
            ...
            <div
                className=' flex flex-col lg:flex-row items-center justify-between gap-10 container mt-[64px]'>
                <div
            ...
            <div
                className='flex flex-col lg:flex-row items-start gap-20 my-[64px] container'>
