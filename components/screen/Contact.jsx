...
const Contact = () => {
    return (
        <div>
        <div
            className={`text-center h-[300px] contactBanner mt-12  ${styles.contactBanner}`}>
            <div className=' bg-primary-700/80 w-full h-full flex items-center justify-center text-white'>
                <div>
                    <h1
                        className='text-[20px] md:text-[25px] lg:text-[32px] font-bold'>Feel free contract with us</h1>
                    <p
                        className='text-[12px] md:text-[16px] max-w-[400px] mx-auto mt-[8px]'>A
        ...
        <div className=' flex flex-col lg:flex-row items-center justify-between gap-10 container mt-[64px]'>
            <div
                className='border w-full h-[180px] rounded-[10px] text-center flex items-center justify-center'>
                <div>
                    <h2 className='mb-[8px] font-bold text-[24px]'>
                        <span className='text-primary-500'>E</span>mail</h2>
            ...
            <div
                ...
                <div>
                    <h2 className='mb-[8px] font-bold text-[24px]'>
                        <span className='text-primary-500'>P</span>hone</h2>
            ...
            <div
                ...
                <div>
                    <h2 className='mb-[8px] font-bold text-[24px]'>
                        <span className='text-primary-500'>A</span>ddress</h2>
