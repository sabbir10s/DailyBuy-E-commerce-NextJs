    ...
    <div className="pt-20 px-3 lg:mb-10">
      <div className="lg:w-[970px] lg:h-[600px] mx-auto rounded-lg shadow-custom grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
        <div className="w-full h-full">
          <Image className="w-full h-full rounded-t-lg lg:rounded-l-lg" src={error} alt="" />
        </div>
        <div className="pr-3">
          ...
          <form onSubmit={(e) => e.preventDefault()} action="#" className="space-y-5 pl-2 lg:pl-0 lg:px-2">
            ...
            <p className="flex items-center lg:w-5/6 mx-auto">
              ...
              <span>
                I agree to <Link href='/termsCondition' className="text-primary-600 hover:underline cursor-pointer font-bold">terms and condition</Link>
              </span>
            </p>
