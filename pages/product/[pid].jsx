    ...
    <div className="mt-20 lg:mt-0">
        ...
        <div className="md:mt-[32px] grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
          <div className="space-y-4 cursor-pointer col-span-1">
            <div className=" w-full h-full lg:h-[400px] border border-gray-100">
             <Image className="w-full h-full object-center object-fill rounded-[24px]" width={250} height={250} src={activeImg} alt="" />
            </div>
      ...
      <div className="hidden md:block">
        <div
          ...
          <h2
            className="text-sm md:text-2xl lg:text-4xl font-semibold text-center lg:text-left">Related Product</h2>
